...
/-
English: there exists b of type boolean. If b and true is false, then there exists a bool that satisfies true.
-/
begin
  assume h,
  cases h with w pf,
...
example : 
  ...
  (∃ (b : Ball), Red b) :=
  /-
  There exists a ball that is red and green, then there exists a ball that is red.
  -/
begin
  assume h,
  cases h with b rg,
...
example : 
  ...
  /-
  If there exists a ball thats green or red, then there exists a ball that is red or green
  -/
begin
  assume h,
  cases h with w rorg,
...
/-
If there is a person that everyone likes, then for each person, there is someone who they like.
-/
begin
  assume h,
  assume e,
