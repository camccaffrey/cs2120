...
Theorem: 2 = 2.
Proof: The reflexive axiom of equality stipulates that every object, t, of every type, T, is equal to itself. Therefore, 2, an object of type N, is equal to itself.
