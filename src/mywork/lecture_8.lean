/-
∧ is defined to be right-associative. Therefore, P ∧ (Q ∧ R) = P ∧ Q ∧ R

and.intro = and introduction rule 
and.elim left/right = and elimination rule
-/
...
begin
  ...
  exact and.intro p (and.intro q r), 
    --exact: not allowed to use place holders
    --apply: can use place holders, can use subgoals
    -- Example: insert the following...
      -- 16: apply and.intro _ (and.intro q r),
      -- 17 exact p
end
...
#check @or.intro_left -- {} inferred from other argument
