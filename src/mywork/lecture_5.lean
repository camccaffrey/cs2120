...
begin
  assume x h, -- h: x=0
  rw h, -- automatically applies eq.refl
end
...
/-
Given a proof of P and a proof of Q, get back a proof of P AND Q
-/
...
/-
Prove that if arbitrary propositions P and Q are true (which is to say that we have a proof of each of them), then the proposition P ∧ Q is also true
